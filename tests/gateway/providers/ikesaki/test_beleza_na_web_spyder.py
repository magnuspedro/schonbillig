...
class TestBelezaNaWebSpyder(unittest.TestCase):
    ...
    @patch('src.gateway.providers.ikesaki.ikesaki_spyder.IkesakiRequestItens.request_itens')
    @patch('src.gateway.providers.ikesaki.ikesaki_spyder.Request.request')
    def test_fail_product(self, mock_itens, mock_get):
        mock_get.return_value = ['http://www.ikesaki.com.br', 'url']
